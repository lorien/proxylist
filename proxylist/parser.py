...
class ProxyListParser(BaseProxyListParser):
    @classmethod
    def parse_proxy_line(cls, line: str) -> tuple[str, int, None | str, None | str]:
    ...
    def parse_raw_list_data(
        ...
        for orig_line in data.splitlines():
            ...
            if line and not line.startswith("#"):
                try:
                    host, port, username, password = cls.parse_proxy_line(line)
